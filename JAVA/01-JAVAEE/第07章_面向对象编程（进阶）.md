...
![第2阶段：Java面向对象编程-第07章](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647582.png)
...
![image-20220503102947013](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647583.png)
...
![image-20220808191154534](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647584.png)

**练习2：**

（1）按照如下的UML类图，创建相应的类，提供必要的结构：

![image-20220323211412409](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647585.png)

在提款方法withdraw()中，需要判断用户余额是否能够满足提款数额的要求，如果不能，应给出提示。deposit()方法表示存款。

（2）按照如下的UML类图，创建相应的类，提供必要的结构

![image-20220323211454372](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647586.png)

（3）按照如下的UML类图，创建相应的类，提供必要的结构

![image-20220323211521808](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647587.png)
...
![image-20220323211653907](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647588.png)
...
![image-20220323215921441](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647589.png)

- 绿化：前人栽树，后人乘凉
    

![image-20220520171727778](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647590.png)

“绿水青山，就是金山银山”

- 样貌：
    
    ![image-20220323220246746](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647591.png)
    
- 继承之外，是不是还可以"`进化`"：
    
    ![image-20220323220537644](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647592.png)
...
![image-20220323220923386](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647593.png)

为描述和处理**学生**信息，定义类Student：

![image-20220323221001495](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647594.png)

通过继承，简化Student类的定义：

![image-20220323221050791](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647595.png)

> 说明：Student类继承了父类Person的所有属性和方法，并增加了一个属性school。Person中的属性和方法，Student都可以使用。

**角度二：从下而上**

![](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647596.jpg)

多个类中存在相同属性和行为时，将这些内容抽取到单独一个类中，那么多个类中无需再定义这些属性和行为，只需要和抽取出来的类构成`继承关系`。如图所示：

![](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647597.jpg)

再举例：

![image-20220323221436571](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647598.png)
...
![image-20211230090255997](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647599.png)

**2、子类不能直接访问父类中私有的(private)的成员变量和方法**

子类虽会继承父类私有(private)的成员变量，但子类不能对继承的私有成员变量直接进行访问，可通过继承的get/set方法进行访问。如图所示：

![image-20220323224757212](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647600.png)
...
![image-20220323225441417](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647601.png)
...
![image-20220514162507692](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647602.png)

![image-20220523201405061](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647603.png)
...
![image-20220323231804928](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647604.png)
...
![image-20220323231942361](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647605.png)
...
![image-20211230093627763](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647606.png)

（2）外部类的权限修饰符如果缺省，跨包使用有问题

![image-20211230094236974](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647607.png)

**2、成员的权限修饰符问题**

（1）本包下使用：成员的权限修饰符可以是public、protected、缺省

![image-20211230095320646](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647608.png)

（2）跨包下使用：要求严格

![image-20211230095817784](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647609.png)

（3）跨包使用时，如果类的权限修饰符缺省，成员权限修饰符>类的权限修饰符也没有意义

![image-20211230100219840](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647610.png)
...
![image-20211230110411580](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647611.png)
...
![image-20200227141228450](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647612.png)
...
![image-20200303183542807](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647613.png)
...
![image-20220324003430464](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647614.png)
...
![image-20220324003447242](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647615.png)
...
![image-20220324003616767](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647616.png)

## 6. 子类对象实例化全过程

![image-20220324003713230](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647617.png)

Dog dog = new Dog("小花","小红");

![image-20220324003735416](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647618.png)

![image-20220324003813163](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647619.png)
...
![image-20220324234208997](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647620.png)

前提：Person类中定义了welcome()方法，各个子类重写了welcome()。

![image-20220324234214932](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647621.png)
...
![image-20220324235337563](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647622.png)
...
![image-20220325000034619](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647623.png)
...
![image-20220503104750655](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647624.png)
...
- 只能比较引用类型，Object类源码中equals()的作用与“==”相同：比较是否指向同一个对象。
    ...
    ![image-20220503104750655](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647625.png)
...
![image-20220325002959156](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647626.png)

![image-20220325002932102](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202310230647628.png)
